...
public class StudentAndTeacherHome extends javax.swing.JFrame {
    ...
    private void logoutButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_logoutButtonActionPerformed
        // int key = MessageDialog.showConfirmDialog(this, "Bạn có chắc muốn đăng xuất
        // khỏi hệ thống?", "Xác nhận");
        // if (key == 0) {
        // dispose();
    ...
    private void showStudentsOfTourActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_showStudentsOfTourActionPerformed
        ...
        try {
            ...
            // if (index == -1) {
            // MessageDialog.showInfoDialog(this, "Vui chọn chuyến tham quan mà bạn muốn xem
            // danh sách sinh viên", "Thông báo");
            // return;
            // }
